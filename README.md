[README.md](https://github.com/user-attachments/files/23688338/README.md)
# Chat UI App

Chat interface UI with message bubbles, input toolbar and theming.
...
git branch -M main
git remote add origin https://github.com/akhilbhumar/chat-ui.git
